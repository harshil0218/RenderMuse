...
const PricingCard = ({
  ...
  <div className="relative h-[650px] z-10 mb-5 overflow-hidden rounded-[10px] border-2 border-stroke bg-gray-100 px-8 py-10 shadow-pricing dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-5 xl:p-[50px] flex flex-col">
    <div className="flex-grow">
      ...
      <p className="mb-4 border-b border-stroke pb-4 text-base text-body-color dark:border-dark-3 dark:text-dark-6">
        {description}
      </p>
      <div className="mb-4 flex flex-col gap-[14px] text-body-color dark:text-dark-6">
    ...
    <div>
      <span className="absolute right-0 top-4 z-[-1]">
      <svg
                width={77}
                height={150}
                viewBox="0 0 77 172"
