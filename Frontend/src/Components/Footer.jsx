  ...
  return (
    <footer class="bg-gray-200 dark:bg-gray-700  ">
      <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-800 dark:text-gray-100 hover:text-gray-900 dark:hover:text-gray-200">
        ...
        <ul class="mt-8 flex justify-center gap-6 md:gap-8 text-gray-800 dark:text-gray-100">
          <li>
            <a
              href="#"
              rel="noreferrer"
      ...
      <div className="justify-items-center border-gray-100 ">
        <div className="border-t border-gray-200 dark:border-gray-700 py-4">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <ul className="flex flex-wrap justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
              <li>
                <a href="#" className="transition hover:opacity-75">
                  Terms & Conditions <span className="font-bold">&middot;</span>
                </a>
              </li>
              <li>
                <a href="#" className="transition hover:opacity-75">
                  Privacy Policy <span className="font-bold">&middot;</span>
                </a>
              </li>
              <li>
                <a href="#" className="transition hover:opacity-75">
            ...
            <p className="mt-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
